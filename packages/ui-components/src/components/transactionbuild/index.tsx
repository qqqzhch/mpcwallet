    ...
    <div className="flex flex-col sm:flex-row">
      ...
      <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          {transactions.map((item,index)=>{
              return (<li className="pb-3 sm:pb-4 sm:max-w-sm" key={index}>
              <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                     ...
                     to: {cutOut(item.raw.to,10,10)}
                     
                      </p>
                  </div>
                  <div  onClick={()=>{deleteTransaction(index)}} className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white cursor-pointer">
                    x 
                  </div>
              </div>
          </li>)
